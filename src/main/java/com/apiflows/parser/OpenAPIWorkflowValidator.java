...
public class OpenAPIWorkflowValidator {
    ...
    List<String> validateCriterion(Criterion criterion, String stepId) {
        ...
        if (criterion.getType() != null && !criterion.getType().equals("simple") && criterion.getContext() == null) {
            errors.add("Step " + stepId + " Non Simple SuccessCriteria type is specified but context is not provided");
        }
